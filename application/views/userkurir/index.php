...
<div class="container-fluid">
   ...
   <div class="table-responsive table-bordered col-sm-12 ml-auto mr-auto mt-2">
      <div class="page-header">
        <span class="fa fa-fw fa-address-book text-warning mt-2"> Data Pengiriman</span>
        <a href="<?= base_url('userkurir/datapengiriman'); ?>"><i class="fas fa-search text-primary mt-2 float-right"> Tampilkan</i></a>
      </div>
